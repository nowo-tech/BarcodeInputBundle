...
namespace Nowo\BarcodeInputBundle\DependencyInjection\Compiler;
 ...
 * application overrides (templates/bundles/NowoBarcodeInputBundle/) are consulted first.
 */
final class TwigPathsPass implements CompilerPassInterface
{
    private const TWIG_NAMESPACE = 'NowoBarcodeInputBundle';
