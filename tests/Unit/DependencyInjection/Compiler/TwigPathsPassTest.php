...
namespace Nowo\BarcodeInputBundle\Tests\Unit\DependencyInjection\Compiler;
...
/**
 * @covers \Nowo\BarcodeInputBundle\DependencyInjection\Compiler\TwigPathsPass
 */
final class TwigPathsPassTest extends TestCase
{
    public function testProcessAddsViewsPathWhenNativeLoaderAliasExists(): void
    {
        ...
        self::assertSame(
            [dirname(__DIR__, 4) . '/src/Resources/views', 'NowoBarcodeInputBundle'],
            $calls[0][1],
        );
    }
